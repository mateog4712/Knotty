/*
  ...
  gengetopt --input=Knotty.ggo --c-extension=cc --header-extension=hh --arg-struct-name=args_info --unamed-opts=input
...
const char *args_info_usage = "Usage: Braidz [options] [sequence]";
...
void init_args_info(struct args_info *args_info)
{
  ...
  args_info->windowing_help = args_info_help[6] ;
  args_info->noConv_help = args_info_help[7] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:d:P:w::", long_options, &option_index);
