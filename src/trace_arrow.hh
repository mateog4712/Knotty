...
public:
     ...
     */
    TraceArrows(cand_pos_t n, const MType &src_mtype, const std::vector<int> *index);
...
private:
     ...
     */
    TraceArrow *
    trace_arrow_from(cand_pos_t i, cand_pos_t j, cand_pos_t k, cand_pos_t l) {
        int ij = (*index_)[i]+j-i;
     ...
     * @return number
     */
    cand_pos_t number() const;

    /** @brief Capacity of trace arrows vectors
     * @return capacity
     */
    cand_pos_t capacity() const;
...
public:
     ...
     * @param n sequence length
     */
    MasterTraceArrows(cand_pos_t n, const std::vector<int> &index);
...
private:
     ...
     */
    void
    gc_row( cand_pos_t i, TraceArrows &source );
    ...
    */
    void
    gc_to_target(cand_pos_t i, cand_pos_t j, cand_pos_t k, cand_pos_t l, TraceArrows &target);
